...
- Input **arguments**, there can be multiple coma seperated inputs to
  the function.
...
chance this to work with the nucleotides A C G and T and return 3 of
them
...
```
     ...
     [1] "A" "T" "C" "G" "T" "A" "A" "G" "C" "A" "C" "T" "A" "C" "A"
...
```
     ...
     [1] "A" "A" "G" "A" "C" "T" "A" "C" "G" "A" "C" "A" "C" "G" "T"
...
``` r
generate_protein <- function(size=10, fasta=TRUE) {
...
One approach is to do this by brute force calling out function for each
length 5 to 12.
...
```
    ...
    [1] "GASLDA"       "KTPNTEN"      "DSVWGIDV"     "ANYYEHWDH"    "PCTAPMVRVC"  
    [6] "DVSEEYINFFF"  "YWMQMLTKYIRL"
