...
- Input **arguments**, there can be multiple coma seperated inputs to the function. 
...
chance this to work with the nucleotides A C G and T and return 3 of them
...
One approach is to do this by brute force calling out function for each length 5 to 12. 
...
> **Key-Point**: Writing functions in R is doable but not the eaisest thing. Starting with a working snippet of code and then using LLM tools to improve and generalize your function code is a productive approach. 
